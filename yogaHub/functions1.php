...
{
    echo "generateRandomUSerID start";
...
function fetchUserDetails($username)
{
   // echo "@@@@@@@@@@@@@@@@@@@Hey";
    ...
    while($stmt->fetch()) {
        ...
        echo "looooooooooooooooooooooooooooooooooooooooooooooooooooopppppppppppppppppppppppppppppppppppppppp";
    }//
    echo "Trial:";
    echo $UserID, $userrole, $username, $password;
    echo $row;
...
function updateThisRecord($instructorname)
{
   // echo "updateThisRecord :  1111111111111111111111111111111111";
    ...
    $stmt->bind_param("si", $instructorname, $loggedInUser->user_id);
    $result = $stmt->execute();
    $stmt->close();
